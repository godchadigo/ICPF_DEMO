...
namespace TouchSocket.Sockets
{
    ...
    public static class HttpConfigExtensions
    {
        ...
        /// <param name="config"></param>
        /// <returns></returns>
        public static TouchSocket.Http.HttpClient BuildWithHttpClient(this TouchSocketConfig config)
        {
            return BuildWithHttpClient< TouchSocket.Http.HttpClient> (config);
        }
